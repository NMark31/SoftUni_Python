...
class OpenBracket(QLabel):
    def __init__(self, widget, show=False, negate=False):
        ...
        self.setAlignment(QtCore.Qt.AlignCenter | QtCore.Qt.AlignVCenter)  # type: ignore
        if show:
            if negate:
                self.setText('not(')
            else:
...
class Expression:
    def __init__(self, widget, width, height, x_pos, y_pos,
        ...
        self.equal_label.setAlignment(QtCore.Qt.AlignCenter | QtCore.Qt.AlignVCenter)  # type: ignore
